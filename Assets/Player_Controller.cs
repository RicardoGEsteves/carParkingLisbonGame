...
public class Player_Controller : MonoBehaviour
{
    ...
    private Level_Controll anotherscript;
    float i = 0;
    Vector3 originalPos;
    ...
    //function to start the car moving again
    ...
    void Start()
    {
        ...
        anotherscript = levelController.GetComponent<Level_Controll>();
        StopCar = true;
        //anotherscript2 = Nivel2Script.GetComponent<Nivel2Script>();
    ...
    //control the car movements: left, right, up, down and brake.
    void Update()
    {
